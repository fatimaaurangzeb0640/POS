...
namespace POS_Management_System
{
    public partial class Form1_POS : MetroFramework.Forms.MetroForm
    {
        ...
        {
            connection.ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\\Users/Fatima/Desktop/Fatima and Areesha/POS Management System/smsystem.accdb;";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            var memoNo = (DateTime.UtcNow - new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc)).TotalSeconds;
            sb.Append("PEAKY BLINDERS\n");
            sb.Append("Plot # SB-19&20 Block 7 Gulistan-E-Jauher, Karachi.\n\n");
            sb.Append("ORIGINAL BILL\n");
            sb.Append("Memo #: " + Convert.ToInt32(memoNo) + "\t\t\tDate: " + DateTime.Now + "\n");
